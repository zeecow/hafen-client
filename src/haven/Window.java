...
public class Window extends Widget {
    ...
    public static final Text.Furnace cf = Text.Imager.of(new PUtils.TexFurn(new Text.Foundry(Text.serif, 15).aa(false), ctex),
	in -> rasterimg(blurmask2(in.img.getRaster(), UI.rscale(0.75), UI.rscale(1.0), new Color(96, 96, 0))));
    public static final Text.Furnace ncf = Text.Imager.of(new PUtils.TexFurn(new Text.Foundry(Text.serif, 15).aa(false), ctex),
	...
	public DefaultDeco(boolean lg) {
		...
		cbtn = add(new ZeeWindow.ZeeButton(ZeeWindow.ZeeButton.BUTTON_SIZE, ZeeWindow.ZeeButton.TEXT_CLOSE).action(() -> ((Window)parent).reqclose()));
	}
