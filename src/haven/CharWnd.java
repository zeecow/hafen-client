...
public class CharWnd extends Window {
	...
	if(place == "study") {
	    ...
	    Widget inf = sattr.add(new StudyInfo(new Coord(attrw - UI.scale(150), child.sz.y), (Inventory) child), new Coord(width + margin1 + UI.scale(150), child.c.y).add(wbox.btloff().x, 0));
