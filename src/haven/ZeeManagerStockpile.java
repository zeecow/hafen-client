...
public class ZeeManagerStockpile extends ZeeThread{
    ...
    public static void checkPlob(MapView.Plob plob) {
        ...
        lastPlob = plob;
        // plob mine support radius
        if (ZeeManagerGobs.isGobMineSupport(plob.getres().name))
            ZeeConfig.toggleMineSupport(plob);
    }
    ...
    static Coord2d lastSandTileClicked=null;
            ...
            public void run() {
                try{
                    ...
                    if (ZeeManagerItems.pickUpInvItem(inv, "/sand")) {
                        ...
                        ZeeManagerGobs.itemActGob(existingPile, UI.MOD_SHIFT);
                        //wait piling
                        if (lastSandTileClicked!=null && waitNotHoldingItem()) {
                            //dig sand again
