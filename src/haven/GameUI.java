...
public class GameUI extends ConsoleHost implements Console.Directory {
	...
	if(place == "mapview") {
	    ...
	    mmap = blpanel.add(new LocalMiniMap2(UI.scale(new Coord(133, 133)), map), minimapc);
	    mmap.lower();
		...
		mmap.save(file);
		mapfile = new MapWnd2(mmap.save, map, Utils.getprefc("wndsz-map", UI.scale(new Coord(700, 500))), "Map");
		mapfile.hide();
