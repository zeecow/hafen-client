...
public class BPRad extends Sprite {
    static final Pipe.Op smat = new BaseColor(new java.awt.Color(139, 139, 185, 48));
    static final Pipe.Op emat = Pipe.Op.compose(new BaseColor(new java.awt.Color(139, 139, 185, 48)), new States.LineWidth(1));
