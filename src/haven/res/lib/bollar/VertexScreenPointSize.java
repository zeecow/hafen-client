...
public class VertexScreenPointSize extends State {
    public static final Attribute size = new Attribute(FLOAT, "ptsz");
    ...
    public static final VertexScreenPointSize global = new VertexScreenPointSize();
}
