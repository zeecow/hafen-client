...
public abstract class OpenGL implements haven.render.gl.GL {
	...
	private final MethodHandle glAttachShader = lookup("glAttachShader", FunctionDescriptor.ofVoid(GLuint, GLuint));
	...
	private final MethodHandle glBindAttribLocation = lookup("glBindAttribLocation", FunctionDescriptor.ofVoid(GLuint, GLuint, ADDRESS));
	...
	private final MethodHandle glBindBuffer = lookup("glBindBuffer", FunctionDescriptor.ofVoid(GLenum, GLuint));
	...
	private final MethodHandle glBindFragDataLocation = lookup("glBindFragDataLocation", FunctionDescriptor.ofVoid(GLuint, GLuint, ADDRESS));
	...
	private final MethodHandle glBindFramebuffer = lookup("glBindFramebuffer", FunctionDescriptor.ofVoid(GLenum, GLuint));
	...
	private final MethodHandle glBindRenderbuffer = lookup("glBindRenderbuffer", FunctionDescriptor.ofVoid(GLenum, GLuint));
	...
	private final MethodHandle glBindTexture = lookup("glBindTexture", FunctionDescriptor.ofVoid(GLenum, GLuint));
	...
	private final MethodHandle glBindVertexArray = lookup("glBindVertexArray", FunctionDescriptor.ofVoid(GLuint));
	...
	private final MethodHandle glBlendColor = lookup("glBlendColor", FunctionDescriptor.ofVoid(GLfloat, GLfloat, GLfloat, GLfloat));
	...
	private final MethodHandle glBlendEquation = lookup("glBlendEquation", FunctionDescriptor.ofVoid(GLenum));
	...
	private final MethodHandle glBlendEquationSeparate = lookup("glBlendEquationSeparate", FunctionDescriptor.ofVoid(GLenum, GLenum));
	...
	private final MethodHandle glBlendFunc = lookup("glBlendFunc", FunctionDescriptor.ofVoid(GLenum, GLenum));
	...
	private final MethodHandle glBlendFuncSeparate = lookup("glBlendFuncSeparate", FunctionDescriptor.ofVoid(GLenum, GLenum, GLenum, GLenum));
	...
	private final MethodHandle glBufferData = lookup("glBufferData", FunctionDescriptor.ofVoid(GLenum, GLsizeiptr, ADDRESS, GLenum));
	...
	private final MethodHandle glBufferSubData = lookup("glBufferSubData", FunctionDescriptor.ofVoid(GLenum, GLintptr, GLsizeiptr, ADDRESS));
	...
	private final MethodHandle glCheckFramebufferStatus = lookup("glCheckFramebufferStatus", FunctionDescriptor.of(GLenum, GLenum));
	...
	private final MethodHandle glClear = lookup("glClear", FunctionDescriptor.ofVoid(GLbitfield));
	...
	private final MethodHandle glClearBufferfv = lookup("glClearBufferfv", FunctionDescriptor.ofVoid(GLenum, GLint, ADDRESS));
	...
	private final MethodHandle glClearBufferiv = lookup("glClearBufferiv", FunctionDescriptor.ofVoid(GLenum, GLint, ADDRESS));
	...
	private final MethodHandle glClearBufferuiv = lookup("glClearBufferuiv", FunctionDescriptor.ofVoid(GLenum, GLint, ADDRESS));
	...
	private final MethodHandle glClearColor = lookup("glClearColor", FunctionDescriptor.ofVoid(GLfloat, GLfloat, GLfloat, GLfloat));
	...
	private final MethodHandle glClearDepth = lookup("glClearDepth", FunctionDescriptor.ofVoid(GLdouble));
	...
	private final MethodHandle glColorMask = lookup("glColorMask", FunctionDescriptor.ofVoid(GLboolean, GLboolean, GLboolean, GLboolean));
	...
	private final MethodHandle glColorMaski = lookup("glColorMaski", FunctionDescriptor.ofVoid(GLuint, GLboolean, GLboolean, GLboolean, GLboolean));
	...
	private final MethodHandle glCompileShader = lookup("glCompileShader", FunctionDescriptor.ofVoid(GLuint));
	...
	private final MethodHandle glCreateProgram = lookup("glCreateProgram", FunctionDescriptor.of(GLuint));
	...
	private final MethodHandle glCreateShader = lookup("glCreateShader", FunctionDescriptor.of(GLuint, GLenum));
	...
	private final MethodHandle glDeleteBuffers = lookup("glDeleteBuffers", FunctionDescriptor.ofVoid(GLsizei, ADDRESS));
	...
	private final MethodHandle glDeleteFramebuffers = lookup("glDeleteFramebuffers", FunctionDescriptor.ofVoid(GLsizei, ADDRESS));
	...
	private final MethodHandle glDeleteShader = lookup("glDeleteShader", FunctionDescriptor.ofVoid(GLuint));
	...
	private final MethodHandle glDeleteProgram = lookup("glDeleteProgram", FunctionDescriptor.ofVoid(GLuint));
	...
	private final MethodHandle glDeleteQueries = lookup("glDeleteQueries", FunctionDescriptor.ofVoid(GLsizei, ADDRESS));
	...
	private final MethodHandle glDeleteRenderbuffers = lookup("glDeleteRenderbuffers", FunctionDescriptor.ofVoid(GLsizei, ADDRESS));
	...
	private final MethodHandle glDeleteSync = lookup("glDeleteSync", FunctionDescriptor.ofVoid(GLsync));
	...
	private final MethodHandle glDeleteTextures = lookup("glDeleteTextures", FunctionDescriptor.ofVoid(GLsizei, ADDRESS));
	...
	private final MethodHandle glDeleteVertexArrays = lookup("glDeleteVertexArrays", FunctionDescriptor.ofVoid(GLsizei, ADDRESS));
	...
	private final MethodHandle glCullFace = lookup("glCullFace", FunctionDescriptor.ofVoid(GLenum));
	...
	private final MethodHandle glDebugMessageControl = lookup("glDebugMessageControl", FunctionDescriptor.ofVoid(GLenum, GLenum, GLenum, GLsizei, ADDRESS, GLboolean));
	...
	private final MethodHandle glDepthFunc = lookup("glDepthFunc", FunctionDescriptor.ofVoid(GLenum));
	...
	private final MethodHandle glDepthMask = lookup("glDepthMask", FunctionDescriptor.ofVoid(GLboolean));
	...
	private final MethodHandle glDisable = lookup("glDisable", FunctionDescriptor.ofVoid(GLenum));
	...
	private final MethodHandle glDisablei = lookup("glDisablei", FunctionDescriptor.ofVoid(GLenum, GLuint));
	...
	private final MethodHandle glDrawBuffer = lookup("glDrawBuffer", FunctionDescriptor.ofVoid(GLenum));
	...
	private final MethodHandle glDrawBuffers = lookup("glDrawBuffers", FunctionDescriptor.ofVoid(GLsizei, ADDRESS));
	...
	private final MethodHandle glDrawArraysInstanced = lookup("glDrawArraysInstanced", FunctionDescriptor.ofVoid(GLenum, GLint, GLsizei, GLsizei));
	...
	private final MethodHandle glDrawArrays = lookup("glDrawArrays", FunctionDescriptor.ofVoid(GLenum, GLint, GLsizei));
	...
	private final MethodHandle glDrawElementsInstanced = lookup("glDrawElementsInstanced", FunctionDescriptor.ofVoid(GLenum, GLsizei, GLenum, PTRINT_T, GLsizei));
	...
	private final MethodHandle glDrawElements = lookup("glDrawElements", FunctionDescriptor.ofVoid(GLenum, GLsizei, GLenum, PTRINT_T));
	...
	private final MethodHandle glDrawRangeElements = lookup("glDrawRangeElements", FunctionDescriptor.ofVoid(GLenum, GLuint, GLuint, GLsizei, GLenum, PTRINT_T));
	...
	private final MethodHandle glEnable = lookup("glEnable", FunctionDescriptor.ofVoid(GLenum));
	...
	private final MethodHandle glEnablei = lookup("glEnablei", FunctionDescriptor.ofVoid(GLenum, GLuint));
	...
	private final MethodHandle glEnableVertexAttribArray = lookup("glEnableVertexAttribArray", FunctionDescriptor.ofVoid(GLuint));
	...
	private final MethodHandle glFenceSync = lookup("glFenceSync", FunctionDescriptor.of(GLsync, GLenum, GLbitfield));
	...
	private final MethodHandle glFinish = lookup("glFinish", FunctionDescriptor.ofVoid());
	...
	private final MethodHandle glFramebufferTexture2D = lookup("glFramebufferTexture2D", FunctionDescriptor.ofVoid(C_INT, C_INT, C_INT, C_INT, C_INT));
	...
	private final MethodHandle glFramebufferRenderbuffer = lookup("glFramebufferRenderbuffer", FunctionDescriptor.ofVoid(GLenum, GLenum, GLenum, GLuint));
	...
	private final MethodHandle glGenBuffers = lookup("glGenBuffers", FunctionDescriptor.ofVoid(GLsizei, ADDRESS));
	...
	private final MethodHandle glGenFramebuffers = lookup("glGenFramebuffers", FunctionDescriptor.ofVoid(GLsizei, ADDRESS));
	...
	private final MethodHandle glGenQueries = lookup("glGenQueries", FunctionDescriptor.ofVoid(GLsizei, ADDRESS));
	...
	private final MethodHandle glGenTextures = lookup("glGenTextures", FunctionDescriptor.ofVoid(GLsizei, ADDRESS));
	...
	private final MethodHandle glGenVertexArrays = lookup("glGenVertexArrays", FunctionDescriptor.ofVoid(GLsizei, ADDRESS));
	...
	private final MethodHandle glGetBufferSubData = lookup("glGetBufferSubData", FunctionDescriptor.ofVoid(GLenum, GLintptr, GLsizeiptr, ADDRESS));
	...
	private final MethodHandle glGetDebugMessageLog = lookup("glGetDebugMessageLog", FunctionDescriptor.of(GLuint, GLuint, GLsizei, ADDRESS, ADDRESS, ADDRESS, ADDRESS, ADDRESS, ADDRESS));
	...
	private final MethodHandle glGetError = lookup("glGetError", FunctionDescriptor.of(GLenum));
	...
	private final MethodHandle glGetFloatv = lookup("glGetFloatv", FunctionDescriptor.ofVoid(GLenum, ADDRESS));
	...
	private final MethodHandle glGetIntegerv = lookup("glGetIntegerv", FunctionDescriptor.ofVoid(GLenum, ADDRESS));
	...
	private final MethodHandle glGetString = lookup("glGetString", FunctionDescriptor.of(ADDRESS, GLenum));
	...
	private final MethodHandle glGetStringi = lookup("glGetStringi", FunctionDescriptor.of(ADDRESS, GLenum, GLuint));
	...
	private final MethodHandle glGetProgramInfoLog = lookup("glGetProgramInfoLog", FunctionDescriptor.ofVoid(GLuint, GLsizei, ADDRESS, ADDRESS));
	...
	private final MethodHandle glGetProgramiv = lookup("glGetProgramiv", FunctionDescriptor.ofVoid(GLuint, GLenum, ADDRESS));
	...
	private final MethodHandle glGetQueryObjectiv = lookup("glGetQueryObjectiv", FunctionDescriptor.ofVoid(GLuint, GLenum, ADDRESS));
	...
	private final MethodHandle glGetQueryObjecti64v = lookup("glGetQueryObjecti64v", FunctionDescriptor.ofVoid(GLuint, GLenum, ADDRESS));
	...
	private final MethodHandle glGetShaderInfoLog = lookup("glGetShaderInfoLog", FunctionDescriptor.ofVoid(GLuint, GLsizei, ADDRESS, ADDRESS));
	...
	private final MethodHandle glGetShaderiv = lookup("glGetShaderiv", FunctionDescriptor.ofVoid(GLuint, GLenum, ADDRESS));
	...
	private final MethodHandle glGetSynciv = lookup("glGetSynciv", FunctionDescriptor.ofVoid(GLsync, GLenum, GLsizei, ADDRESS, ADDRESS));
	...
	private final MethodHandle glGetTexImage = lookup("glGetTexImage", FunctionDescriptor.ofVoid(GLenum, GLint, GLenum, GLenum, ADDRESS));
	...
	private final MethodHandle glGetTexImage2 = lookup("glGetTexImage", FunctionDescriptor.ofVoid(GLenum, GLint, GLenum, GLenum, PTRINT_T));
	...
	private final MethodHandle glGetUniformLocation = lookup("glGetUniformLocation", FunctionDescriptor.of(GLint, GLuint, ADDRESS));
	...
	private final MethodHandle glLineWidth = lookup("glLineWidth", FunctionDescriptor.ofVoid(GLfloat));
	...
	private final MethodHandle glLinkProgram = lookup("glLinkProgram", FunctionDescriptor.ofVoid(GLuint));
	...
	private final MethodHandle glObjectLabel = lookup("glObjectLabel", FunctionDescriptor.ofVoid(GLenum, GLuint, GLsizei, ADDRESS));
	...
	private final MethodHandle glPixelStorei = lookup("glPixelStorei", FunctionDescriptor.ofVoid(GLenum, GLint));
	...
	private final MethodHandle glPointSize = lookup("glPointSize", FunctionDescriptor.ofVoid(GLfloat));
	...
	private final MethodHandle glPolygonMode = lookup("glPolygonMode", FunctionDescriptor.ofVoid(GLenum, GLenum));
	...
	private final MethodHandle glPolygonOffset = lookup("glPolygonOffset", FunctionDescriptor.ofVoid(GLfloat, GLfloat));
	...
	private final MethodHandle glQueryCounter = lookup("glQueryCounter", FunctionDescriptor.ofVoid(GLuint, GLenum));
	...
	private final MethodHandle glReadBuffer = lookup("glReadBuffer", FunctionDescriptor.ofVoid(GLenum));
	...
	private final MethodHandle glReadPixels = lookup("glReadPixels", FunctionDescriptor.ofVoid(GLint, GLint, GLsizei, GLsizei, GLenum, GLenum, ADDRESS));
	...
	private final MethodHandle glReadPixels2 = lookup("glReadPixels", FunctionDescriptor.ofVoid(GLint, GLint, GLsizei, GLsizei, GLenum, GLenum, PTRINT_T));
	...
	private final MethodHandle glRenderbufferStorage = lookup("glRenderbufferStorage", FunctionDescriptor.ofVoid(GLenum, GLenum, GLsizei, GLsizei));
	...
	private final MethodHandle glRenderbufferStorageMultisample = lookup("glRenderbufferStorageMultisample", FunctionDescriptor.ofVoid(GLenum, GLsizei, GLenum, GLsizei, GLsizei));
	...
	private final MethodHandle glSampleCoverage = lookup("glSampleCoverage", FunctionDescriptor.ofVoid(GLfloat, GLboolean));
	...
	private final MethodHandle glScissor = lookup("glScissor", FunctionDescriptor.ofVoid(GLint, GLint, GLsizei, GLsizei));
	...
	private final MethodHandle glShaderSource = lookup("glShaderSource", FunctionDescriptor.ofVoid(GLuint, GLsizei, ADDRESS, ADDRESS));
	...
	private final MethodHandle glTexImage2D = lookup("glTexImage2D", FunctionDescriptor.ofVoid(GLenum, GLint, GLint, GLsizei, GLsizei, GLint, GLenum, GLenum, ADDRESS));
	...
	private final MethodHandle glTexSubImage2D = lookup("glTexSubImage2D", FunctionDescriptor.ofVoid(GLenum, GLint, GLint, GLint, GLsizei, GLsizei, GLenum, GLenum, ADDRESS));
	...
	private final MethodHandle glTexImage2DMultisample = lookup("glTexImage2DMultisample", FunctionDescriptor.ofVoid(GLenum, GLsizei, GLenum, GLsizei, GLsizei, GLboolean));
	...
	private final MethodHandle glTexImage3D = lookup("glTexImage3D", FunctionDescriptor.ofVoid(GLenum, GLint, GLint, GLsizei, GLsizei, GLsizei, GLint, GLenum, GLenum, ADDRESS));
	...
	private final MethodHandle glTexSubImage3D = lookup("glTexSubImage3D", FunctionDescriptor.ofVoid(GLenum, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLenum, GLenum, ADDRESS));
	...
	private final MethodHandle glTexParameterf = lookup("glTexParameterf", FunctionDescriptor.ofVoid(GLenum, GLenum, GLfloat));
	...
	private final MethodHandle glTexParameterfv = lookup("glTexParameterfv", FunctionDescriptor.ofVoid(GLenum, GLenum, ADDRESS));
	...
	private final MethodHandle glTexParameteri = lookup("glTexParameteri", FunctionDescriptor.ofVoid(GLenum, GLenum, GLint));
	...
	private final MethodHandle glUniform1f = lookup("glUniform1f", FunctionDescriptor.ofVoid(GLint, GLfloat));
	...
	private final MethodHandle glUniform2f = lookup("glUniform2f", FunctionDescriptor.ofVoid(GLint, GLfloat, GLfloat));
	...
	private final MethodHandle glUniform3f = lookup("glUniform3f", FunctionDescriptor.ofVoid(GLint, GLfloat, GLfloat, GLfloat));
	...
	private final MethodHandle glUniform3fv = lookup("glUniform3fv", FunctionDescriptor.ofVoid(GLint, GLsizei, ADDRESS));
	...
	private final MethodHandle glUniform4f = lookup("glUniform4f", FunctionDescriptor.ofVoid(GLint, GLfloat, GLfloat, GLfloat, GLfloat));
	...
	private final MethodHandle glUniform4fv = lookup("glUniform4fv", FunctionDescriptor.ofVoid(GLint, GLsizei, ADDRESS));
	...
	private final MethodHandle glUniform1i = lookup("glUniform1i", FunctionDescriptor.ofVoid(GLint, GLint));
	...
	private final MethodHandle glUniform2i = lookup("glUniform2i", FunctionDescriptor.ofVoid(GLint, GLint, GLint));
	...
	private final MethodHandle glUniform3i = lookup("glUniform3i", FunctionDescriptor.ofVoid(GLint, GLint, GLint, GLint));
	...
	private final MethodHandle glUniform4i = lookup("glUniform4i", FunctionDescriptor.ofVoid(GLint, GLint, GLint, GLint, GLint));
	...
	private final MethodHandle glUniformMatrix3fv = lookup("glUniformMatrix3fv", FunctionDescriptor.ofVoid(GLint, GLsizei, GLboolean, ADDRESS));
	...
	private final MethodHandle glUniformMatrix4fv = lookup("glUniformMatrix4fv", FunctionDescriptor.ofVoid(GLint, GLsizei, GLboolean, ADDRESS));
	...
	private final MethodHandle glUseProgram = lookup("glUseProgram", FunctionDescriptor.ofVoid(GLuint));
	...
	private final MethodHandle glVertexAttribDivisor = lookup("glVertexAttribDivisor", FunctionDescriptor.ofVoid(GLuint, GLuint));
	...
	private final MethodHandle glVertexAttribPointer = lookup("glVertexAttribPointer", FunctionDescriptor.ofVoid(GLuint, GLint, GLenum, GLboolean, GLsizei, PTRINT_T));
	...
	private final MethodHandle glVertexAttribIPointer = lookup("glVertexAttribIPointer", FunctionDescriptor.ofVoid(GLuint, GLint, GLenum, GLsizei, PTRINT_T));
	...
	private final MethodHandle glViewport = lookup("glViewport", FunctionDescriptor.ofVoid(GLint, GLint, GLsizei, GLsizei));
